...
var t,e,n=require("./geo"),o=require("./test-data"),a=null,i=!1;function l(e){var n=t.innerHTML;t.innerHTML="<p>"+e+"</p>"+n}function r(){var t={};return location.search.substr(1).split("&").forEach(function(e){var n=e.split("=");t[n[0]]=decodeURIComponent(n[1])}),t}function u(t,n){e.style.top=n+"%",e.style.left=t+"%"}function c(t,e,n){return e<t?t:e>n?n:e}function s(t){var e={lat:t.coords.latitude,lon:t.coords.longitude,altitude:t.coords.altitude},o=n.geoToXyz(e),i=n.geoToXyz({lat:a.lat,lon:a.lon,altitude:a.altitude}),r=n.getDescentVec(i,a.azimuth,a.descentAngle),s=n.correctLanding(i,r,o);l(JSON.stringify(e,null,4)),l(JSON.stringify(s,null,4));var d=c(-500,s.goLeft,500),g=c(-500,s.goDown,500);u(Math.floor(-d/10)+50,Math.floor(g/10)+50)}function d(t){output.innerHTML="Unable to retrieve your location",showAlert("Geo error - "+t.code+" - "+t.message)}function g(){t=document.getElementById("log")}function m(){if(!i)if(i=!0,navigator.geolocation)if(a){l(JSON.stringify(a,null,4)),l("Locating...123");navigator.geolocation.watchPosition(s,d,{enableHighAccuracy:!1,timeout:1e4,maximumAge:5e3})}else l("Define a landing strip first");else l("Geolocation is not supported by your browser")}function f(t){return{coords:{longitude:t.lon,latitude:t.lat,altitude:t.altitude}}}function p(t){const e=n.parseLlaToXyz(t.llaText);n.getDescentVec(e,t.azimuth,t.descentAngle);var o=[t.tests.notBad,t.tests.tooLow,t.tests.tooHigh,t.tests.turnLeft,t.tests.turnRight],a=0;function i(){a>=o.length||(s(f(n.parseLatLonAltitude(o[a]))),a+=1,setTimeout(i,1e3))}i()}function h(){(a=n.parseLatLonAltitude(o.exampleRishon.llaText)).azimuth=o.exampleRishon.azimuth,a.descentAngle=o.exampleRishon.descentAngle,p(o.exampleRishon)}function y(){document.getElementById("start-button").onclick=m,document.getElementById("test-button").onclick=h,e=document.getElementById("runway-icon")}function v(){g(),y();var t=r(),e=document.getElementById("parameters"),n=t.q||"";if(e.value=n,n){var o=n.split(",");a={lat:+o[0],lon:+o[1],altitude:+o[2],azimuth:+o[3],descentAngle:+o[4]}}for(var i=["lat","lon","altitude","azimuth","descentAngle"],u=0;u<i.length;u++){var c=a[i[u]];("number"!=typeof c||isNaN(c))&&l("Invalid parameter: "+i[u]+" = "+c)}}"complete"===document.readyState||"loading"!==document.readyState?v():document.addEventListener("DOMContentLoaded",v);
},{"./geo":11,"./test-data":12}]},{},[8])